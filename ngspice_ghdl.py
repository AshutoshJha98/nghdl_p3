...
class Mainwindow(QtGui.QWidget):
    ...
    def checkSupportFiles(self):
        ...
        if nonvhdl_count > 0:
            QtGui.QMessageBox.about(
                self, 'Message', '''<b>Important Message.</b>
    ...
    def createModelDirectory(self):
        ...
        if os.path.isdir(self.modelname):
            ...
            ret = QtGui.QMessageBox.critical(
                        self, "Critical",
                        "<b>The Model already exist.Do you want to overwrite" +
                        " it?</b><br/><b>If yes press ok else cancel it " +
                        "and change the name of you vhdl file</b>",
    ...
    def createModelFiles(self):
        ...
        shutil.move(str(self.modelname) + "_tb.vhdl", path + "/DUTghdl/")
